            ...
            <div className='relative w-full max-w-md'>
                ...
                <div className='bg-white bg-opacity-10 backdrop-blur-lg rounded-2xl shadow-2xl border border-white border-opacity-20 p-8'>
                    <div className='text-center mb-6'>
                        ...
                        <p className='text-blue-100 text-sm'>Sign in to your BUSIT account</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className='space-y-6'>
                        <div>
                            ...
                            <div className='relative'>
                                ...
                                <input 
                                    ...
                                    className={`w-full pl-10 pr-4 py-3 bg-white bg-opacity-10 border border-white border-opacity-20 rounded-lg text-white placeholder-blue-200 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent backdrop-blur-sm transition-all duration-200 ${error ? 'border-red-400' : ''}`}
                                    name="email" 
                        ...
                        <button 
                            type='submit' 
                            className='w-full bg-gradient-to-r from-blue-500 to-purple-600 text-white py-3 px-4 rounded-lg font-semibold hover:from-blue-600 hover:to-purple-700 transform hover:scale-105 transition-all duration-200 shadow-lg hover:shadow-xl'
                        >
                            Sign In
                        </button>
                    </form>
                    ...
                    <div className='text-center mt-6 space-y-3'>
                        <p className='text-blue-100 text-sm'>
                            ...
                            <Link to="/register" className="text-blue-300 hover:text-white font-medium ml-1 transition-colors duration-200">
                                Create Account
                            </Link>
                        </p>
                        <p className='text-blue-100 text-sm'>
                            <Link to="/forgot-password" className="text-blue-300 hover:text-white font-medium transition-colors duration-200">
